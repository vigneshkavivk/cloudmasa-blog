...
export default function FssaiLicenseServicePanel() {
  ...
  const documents = [
    { icon: CheckCircle, label: "PAN Card (Proprietor/Company)" },
    { icon: Building, label: "Proof of Premises (Rent/Ownership)" },
    { icon: Phone, label: "Active Mobile & Email" },
    { icon: Shield, label: "Food Safety Supervisor Certificate (if applicable)" },
