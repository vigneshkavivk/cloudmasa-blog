...
export default function GstRegistrationForm({ user }: GstRegistrationFormProps) {
  ...
  if (isSuccess) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#020c1b] to-[#0a192f] flex items-center justify-center p-4">
      <div className="bg-slate-900/80 backdrop-blur-xl p-6 md:p-8 rounded-2xl shadow-2xl max-w-2xl w-full border border-slate-700/50">
        {/* Success Header */}
        <div className="text-center mb-6">
          ...
          <p className="text-slate-300">
            Case ID: <span className="text-sky-400 font-mono">GST-2026-8X92B</span>
          </p>
        </div>

        {/* ✅ NEW: Compliance Alert Banner */}
        <div className="bg-gradient-to-r from-amber-900/30 to-orange-900/20 border border-amber-500/30 rounded-xl p-4 mb-6">
          <div className="flex items-start gap-3">
            <svg className="w-5 h-5 text-amber-400 mt-0.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
            </svg>
            <div>
              <h4 className="font-semibold text-white text-sm">⚠️ Important: Post-Registration Compliance</h4>
              <p className="text-xs text-slate-300 mt-1">
                GST registration mudinchaalum, monthly returns file panna marandhaa penalty varum!
              </p>
              <button
                onClick={() => navigate("/gst/compliance-guide")}
                className="mt-2 text-xs font-semibold text-sky-400 hover:text-sky-300 flex items-center gap-1"
              >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6">
          <button
            onClick={() => navigate("/gst/compliance-guide")}
            className="w-full py-3 px-4 bg-slate-800 hover:bg-slate-700 border border-slate-600 rounded-lg text-white text-sm font-medium transition-colors flex items-center justify-center gap-2"
          >
          ...
          <button
            onClick={() => window.open("https://wa.me/919876543210?text=Hi, I need help with my GST registration", "_blank")}
            className="w-full py-3 px-4 bg-emerald-600 hover:bg-emerald-500 rounded-lg text-white text-sm font-medium transition-colors flex items-center justify-center gap-2"
          >
