...
export interface UserProfile {
  ...
  gender?: 'male' | 'female' | 'other'; // Personal Profile
  dob?: string;                 // Personal Profile YYYY-MM-DD
  isTemporary?: boolean;       // Personal Profile
}
...
export interface AppMessage {
  ...
  text: string;
  timestamp: number;
  isStaff: boolean; // To distinguish between customer and support
  subject?: string; // NEW: For email-style communication
