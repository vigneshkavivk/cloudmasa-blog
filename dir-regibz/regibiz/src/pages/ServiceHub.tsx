...
const ServiceHub: React.FC<ServiceHubProps> = ({ user }) => {
  ...
  const categorizedServices: Record<string, Service[]> = {
    recommended: [
      ...
      { id: 'trademark', name: 'Trademark Registration', fee: 0, desc: 'Protect your brand identity from competitors. Class search included.', tag: 'Popular', path: '/services/trademark-registration' },
    ],
    'company-setup': [
    ...
    'licenses-certificates': [
      ...
      { id: 'fssai-basic', name: 'FSSAI Registration/License', fee: 0, desc: 'Mandatory for food business operators with turnover < ₹12L/year.', tag: 'Free', path: '/services/fssai-license' },
