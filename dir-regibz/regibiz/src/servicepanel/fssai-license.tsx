...
import { CheckCircle, Building, Phone, Shield, Truck, ArrowLeft } from "lucide-react";
...
export default function FssaiLicenseServicePanel() {
  ...
  // ✅ FIXED: Correct route path to match App.tsx
  ...
  const benefits = [
    "Legally mandatory for food businesses (even home-based)",
    "Build consumer trust with FSSAI logo on packaging",
    "Required for e-commerce food sales (Amazon, Swiggy, Zomato)",
    "Avoid fines up to ₹5 lakh or imprisonment under FSS Act, 2006",
  ];

  const documents = [
    { icon: CheckCircle, label: "Identity Proof - Aadhaar/PAN CARD (Proprietor/Company)" },
    { icon: Building, label: "Address Proof of Premises (Ownership/Lease)" },
    { icon: Phone, label: "Active Mobile & Email" },
    { icon: Shield, label: "NOC from Municipality/Health Dept (if applicable)" },
    { icon: Truck, label: "Layout Plan & Machinery List (for manufacturing)" },
  ];
  
  const steps = [
    { step: 1, title: "Share Details", desc: "Business type, turnover, premises info" },
    { step: 2, title: "Upload Docs", desc: "PAN, address proof, layout plan, etc." },
    { step: 3, title: "Get License", desc: "FSSAI Registration/License issued in 5–7 days" },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Button
              variant="ghost"
              size="sm"
              className="p-0 h-auto text-white hover:bg-transparent hover:text-emerald-400 md:hidden"
              onClick={handleGoBack}
            >
              <ArrowLeft className="w-5 h-5" />
            </Button>
            <div>
              <h1 className="text-2xl font-bold text-white">FSSAI License</h1>
            ...
            <Card className="glass-card">
              <CardContent className="p-5">
                ...
                <p className="text-gray-400 leading-relaxed">
                  Every food business — from home kitchens to manufacturers — must obtain FSSAI registration or license.
                  Based on turnover & operation type:
                  <br /><br />
                  • <strong>Registration</strong> (Turnover ≤ ₹12 Lakh/year) — Basic, free*  
                  • <strong>State License</strong> (₹12 Lakh – ₹20 Cr)  
                  • <strong>Central License</strong> (₹20 Cr or more, or importers)
                  <br /><br />
                  *Govt fee only; RegiBIZ service fee waived for Basic Registration.
                </p>
              </CardContent>
            </Card>
          ...
          <div className="lg:col-span-2">
            <Card className="glass-card h-full flex flex-col">
              <CardContent className="flex-1 p-6 flex flex-col">
                <div className="mb-6">
                  <h2 className="text-xl font-bold text-white mb-2">Get FSSAI License in 3 Simple Steps</h2>
                  <p className="text-gray-400">We handle Form-A/B/C, verification & follow-up — zero stress.</p>
                </div>
