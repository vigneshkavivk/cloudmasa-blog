export const modules = [
  ...
  },
  {
    id: "ebs",
    name: "EBS Volume",
    price: { gp3: 0.08, io1: 0.125, st1: 0.045 }, // per GB-month (approx US East)
    requirements: ["Volume Name", "Size (GiB)", "Volume Type", "Availability Zone", "Encryption"],
    description: "Elastic Block Store provides persistent block storage volumes for EC2 instances.",
    iacResources: ["aws_ebs_volume"],
  },
  {
    id: "iam",
    name: "IAM",
